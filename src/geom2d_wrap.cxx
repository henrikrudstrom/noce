...
#define SWIGTYPE_p_gp_XY swig_types[36]
#define SWIGTYPE_p_gp_XYZ swig_types[37]
...
static SwigV8ReturnValue _wrap_new_veto_Handle_Ellipse(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIG_exception(SWIG_ERROR, "Class Handle_Ellipse can not be instantiated");
  SWIGV8_RETURN(SWIGV8_UNDEFINED());
}
...
_exports_Handle_Ellipse_class_0->SetCallHandler(_wrap_new_veto_Handle_Ellipse);
